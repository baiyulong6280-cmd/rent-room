CREATE TABLE IF NOT EXISTS "ai_model_call_log" (
    ...
    "price_in_per1m" bigint NOT NULL DEFAULT 0,
    "price_cached_per1m" bigint NOT NULL DEFAULT 0,
    "price_out_per1m" bigint NOT NULL DEFAULT 0,
    "price_reasoning_per1m" bigint NOT NULL DEFAULT 0,
